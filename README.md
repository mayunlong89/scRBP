...
## scRBP workflow
![Workflow](https://github.com/mayunlong89/scRBP/blob/main/Examples/Figure_1 copy.png)
...
scRBP getPrune \
    ...
    --n_jobs             16
```
> This step need to download [motif-based target gene/isoform ranking.feather](https://resources.gandallab.org/scRBP/).
...
Please refer to the [Gandallab resource](https://resources.gandallab.org/scRBP/), we provided 616 RBPs and their corresponding 20746 motifs with quality metrics in [here](https://resources.gandallab.org/scRBP/motifs/). 
