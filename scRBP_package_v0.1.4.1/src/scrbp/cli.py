...
Command-line interface entry point.  Dispatches to one of twelve subcommands:

  getSketch      Stratified GeoSketch downsampling of large single-cell datasets
  getMetacell    Aggregate single cells into mini-metacells for robust GRN inference
  ...
  rgs_rare       Rare-variant regulon genetic association score (TADA / burden)
...
def main():
    ...
    get_metacell.register_subcommand(subparsers)
    ...
    rgs_rare.register_subcommand(subparsers)
